...
If you would like to set up a one-time cronjob, i.e. a cronjob that runs at a specific time, you can follow these instructions:
...
![Auto delete](https://fastcron.zendesk.com/hc/article_attachments/32276446236185)
