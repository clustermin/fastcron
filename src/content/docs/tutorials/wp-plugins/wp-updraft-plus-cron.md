---
title: How to set up cronjob for UpdraftPlus
---

The **UpdraftPlus** plugin relies on [WP Cron](/tutorials/wp-cron) to run its scheduled tasks.
To set up cronjob for your **UpdraftPlus** plugin, you can:
